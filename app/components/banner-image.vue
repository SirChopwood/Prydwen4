...
<template>
  <div v-if="disabled || link === undefined" class="flex flex-col -:w-full h-auto outline outline-2 outline-neutral-800 hover:outline-neutral-700 rounded-sm group transition-all duration-100 ease-in-out">
    ...
    <div class="w-full bg-neutral-900 border-t-2 border-neutral-800 flex flex-row items-center">
      <div class="text-primary font-bold border-r-2 border-secondary text-2xl px-4 py-1 mr-4 stripes">{{title}}</div>
