...
<template>
  <modal-template title="Set Host Name" :name="name" :modal-manager="modalManager" >
    ...
    <input type="text" v-model="hostName" class="w-full rounded-sm bg-neutral-950 p-2 border-2 border-opacity-0 focus:border-opacity-100 border-neutral-700 !outline-none" placeholder="Enter how you want to appear here."/>
