...
INSERT INTO `__new_Raids_V2_Users`("id", "user_id", "raid_id", "team_id", "class", "isHero", "choices") SELECT "id", "user_id", "raid_id", "team_id", "class", "isHero", "choices" FROM `Raids_V2_Users`;--> statement-breakpoint
